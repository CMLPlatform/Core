...
def create_output(input):
    ...
    for line in input:
        ...
        if years < '2005':
            temp_output = '{date : \'' + years + '-01-01\'' + ', RS_timber_hist : ' + timber_hist +', RS_iron_hist : '+\
                          iron_hist+', RS_other_hist : '+ other_hist+', RS_minerals_hist : '+ minerals_hist + '},'
            data_list.append(temp_output)
        elif years == '2005':
            temp_output = '{date : \'' + years + '-01-01\'' + ', RS_timber_hist : ' + timber_hist + ', RS_iron_hist : ' + \
                          iron_hist + ', RS_other_hist : ' + other_hist + ', RS_minerals_hist : ' + minerals_hist + \
                          ', RS_timber_sc1 : ' + timber_sc1 + ', RS_iron_sc1 : ' + \
                          iron_sc1 + ', RS_other_sc1 : ' + other_sc1 + ', RS_minerals_sc1 : ' + minerals_sc1 \
                          + ', RS_timber_sc2 : ' + timber_sc2 + ', RS_iron_sc2 : ' + \
                          iron_sc2 + ', RS_other_sc2 : ' + other_sc2 + ', RS_minerals_sc2 : ' + minerals_sc2 \
                          + '},'
            data_list.append(temp_output)
        #after 2005 we have two scenarios we want to use
        else:
            temp_output = '{date : \'' + years + '-01-01\'' + ', RS_timber_sc1 : ' + timber_sc1 +', RS_iron_sc1 : '+\
                          iron_sc1+', RS_other_sc1 : '+ other_sc1+', RS_minerals_sc1 : '+ minerals_sc1 \
                          + ', RS_timber_sc2 : ' + timber_sc2 + ', RS_iron_sc2 : ' + \
                          iron_sc2 + ', RS_other_sc2 : ' + other_sc2 + ', RS_minerals_sc2 : ' + minerals_sc2+ '},'
            data_list.append(temp_output)
