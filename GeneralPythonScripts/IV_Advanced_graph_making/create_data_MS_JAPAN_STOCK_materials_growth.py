...
def getfile():
    ...
    f=open('../../data/IV_Advanced_graph_making/JAPAN_stock_materials_growth.csv', 'r')
...
def create_output(input):
    ...
    for line in input:
        ...
        if years < '2005':
            temp_output = '{"date" : "' + years + '-01-01"' + ', "MS_timber_hist_jp" : ' + timber_hist_jp +', "MS_iron_hist_jp" : '+\
                          iron_hist_jp+', "MS_other_hist_jp" : '+ other_hist_jp+', "MS_minerals_hist_jp" : '+ minerals_hist_jp + '},'
            data_list.append(temp_output)
        elif years == '2005':
            temp_output = '{"date" : "' + years + '-01-01"' + ', "MS_timber_hist_jp" : ' + timber_hist_jp + ', "MS_iron_hist_jp" : ' + \
                          iron_hist_jp + ', "MS_other_hist_jp" : ' + other_hist_jp + ', "MS_minerals_hist_jp" : ' + minerals_hist_jp + \
                          ', "MS_timber_sc1_jp" : ' + timber_sc1_jp + ', "MS_iron_sc1_jp" : ' + \
                          iron_sc1_jp + ', "MS_other_sc1_jp" : ' + other_sc1_jp + ', "MS_minerals_sc1_jp" : ' + minerals_sc1_jp \
                          + ', "MS_timber_sc2_jp" : ' + timber_sc2_jp + ', "MS_iron_sc2_jp" : ' + \
                          iron_sc2_jp + ', "MS_other_sc2_jp" : ' + other_sc2_jp + ', "MS_minerals_sc2_jp" : ' + minerals_sc2_jp \
                          + '},'
            data_list.append(temp_output)
        #after 2005 we have two scenarios we want to use
        else:
            temp_output = '{"date" : "' + years + '-01-01"' + ', "MS_timber_sc1_jp" : ' + timber_sc1_jp +', "MS_iron_sc1_jp" : '+\
                          iron_sc1_jp+', "MS_other_sc1_jp" : '+ other_sc1_jp+', "MS_minerals_sc1_jp" : '+ minerals_sc1_jp \
                          + ', "MS_timber_sc2_jp" : ' + timber_sc2_jp + ', "MS_iron_sc2_jp" : ' + \
                          iron_sc2_jp + ', "MS_other_sc2_jp" : ' + other_sc2_jp + ', "MS_minerals_sc2_jp" : ' + minerals_sc2_jp+ '},'
            data_list.append(temp_output)
