...
def create_output(input):
    ...
    for line in input:
        ...
        if years <= '2005':
            ...
            json_string += '"'+str(id)+'":{"scenarios":"MS_Historical_Series_jp","year":'+years+\
